let checkStringAdd = (str, varName) => {
  if (!str) {
...
let checkState = (state) => {
  state = checkStringAdd(state, "state");
...
let errorFoundAdd = (error, shelterVarInput, shelterVarLabel, errorDiv) => {
