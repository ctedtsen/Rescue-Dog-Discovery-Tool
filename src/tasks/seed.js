...
await db.dropDatabase();
    ...
    try{
        ...
        const catGarry = await cats.addCat("Garry", "09/14/2017", "0ft10in", "10lbs", "female", "", "public/petImages/Minuet_cat-Garry.jpeg");
    ...
    const dogVilly = await dogs.addDog("Villy", "04/22/2021", "Belgian Shepherd", "1ft5in", "25lbs", "male", "", "public/petImages/BelgianShepherd-Villy.jpg");
    ...
    const dogAmy = await dogs.addDog("Amy", "06/11/2021", "Harrier", "1ft5in", "25lbs", "female", "", "public/petImages/Harrier-Amy.jpeg");
    ...
    const dogBetty = await dogs.addDog("Betty", "01/11/2018", "Pekingese", "0ft10in", "18lbs", "female", "food allergies", "public/petImages/Pekingese-Betty.jpeg");
    ...
    const dogSam = await dogs.addDog("Sam", "08/11/2020", "Smooth Collie", "2ft2in", "60lbs", "male", "", "public/petImages/Smooth_Collie-Sam.jpeg");
